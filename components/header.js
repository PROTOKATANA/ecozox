...
(function () {
    ...
    var currencies = [
        ...
        { code: 'PKR', flag: 'pk', label: 'Rupia pakistaní',       symbol: '₨'   }
    ];

    var currencyNames = {
        es: { USD:'Dólar estadounidense', EUR:'Euro', CAD:'Dólar canadiense', AUD:'Dólar australiano', GBP:'Libra esterlina', NZD:'Dólar neozelandés', JPY:'Yen japonés', INR:'Rupia india', CNY:'Yuan chino', KRW:'Won surcoreano', RUB:'Rublo ruso', BRL:'Real brasileño', SAR:'Riyal saudí', TRY:'Lira turca', MXN:'Peso mexicano', CLP:'Peso chileno', IDR:'Rupia indonesia', PLN:'Esloti polaco', PKR:'Rupia pakistaní' },
        ...
        ar: { USD:'دولار أمريكي', EUR:'يورو', CAD:'دولار كندي', AUD:'دولار أسترالي', GBP:'جنيه إسترليني', NZD:'دولار نيوزيلندي', JPY:'ين ياباني', INR:'روبية هندية', CNY:'يوان صيني', KRW:'وون كوري جنوبي', RUB:'روبل روسي', BRL:'ريال برازيلي', SAR:'ريال سعودي', TRY:'ليرة تركية', MXN:'بيسو مكسيكي', CLP:'بيسو تشيلي', IDR:'روبية إندونيسية', PLN:'زلوتي بولندي', PKR:'روبية باكستانية' },
        zh: { USD:'美元', EUR:'欧元', CAD:'加元', AUD:'澳元', GBP:'英镑', NZD:'新西兰元', JPY:'日元', INR:'印度卢比', CNY:'人民币', KRW:'韩元', RUB:'俄罗斯卢布', BRL:'巴西雷亚尔', SAR:'沙特里亚尔', TRY:'土耳其里拉', MXN:'墨西哥比索', CLP:'智利比索', IDR:'印尼盾', PLN:'波兰兹罗提', PKR:'巴基斯坦卢比' },
        ja: { USD:'米ドル', EUR:'ユーロ', CAD:'カナダドル', AUD:'オーストラリアドル', GBP:'英ポンド', NZD:'ニュージーランドドル', JPY:'日本円', INR:'インドルピー', CNY:'中国人民元', KRW:'韓国ウォン', RUB:'ロシアルーブル', BRL:'ブラジルレアル', SAR:'サウジリヤル', TRY:'トルコリラ', MXN:'メキシコペソ', CLP:'チリペソ', IDR:'インドネシアルピア', PLN:'ポーランドズウォティ', PKR:'パキスタンルピー' },
        ko: { USD:'미국 달러', EUR:'유로', CAD:'캐나다 달러', AUD:'호주 달러', GBP:'영국 파운드', NZD:'뉴질랜드 달러', JPY:'일본 엔', INR:'인도 루피', CNY:'중국 위안', KRW:'한국 원', RUB:'러시아 루블', BRL:'브라질 헤알', SAR:'사우디 리얄', TRY:'터키 리라', MXN:'멕시코 페소', CLP:'칠레 페소', IDR:'인도네시아 루피아', PLN:'폴란드 즐로티', PKR:'파키스탄 루피' },
        id: { USD:'Dolar AS', EUR:'Euro', CAD:'Dolar Kanada', AUD:'Dolar Australia', GBP:'Pound Inggris', NZD:'Dolar Selandia Baru', JPY:'Yen Jepang', INR:'Rupee India', CNY:'Yuan Tiongkok', KRW:'Won Korea Selatan', RUB:'Rubel Rusia', BRL:'Real Brasil', SAR:'Riyal Saudi', TRY:'Lira Turki', MXN:'Peso Meksiko', CLP:'Peso Chili', IDR:'Rupiah Indonesia', PLN:'Zloty Polandia', PKR:'Rupee Pakistan' },
        de: { USD:'US-Dollar', EUR:'Euro', CAD:'Kanadischer Dollar', AUD:'Australischer Dollar', GBP:'Britisches Pfund', NZD:'Neuseeland-Dollar', JPY:'Japanischer Yen', INR:'Indische Rupie', CNY:'Chinesischer Yuan', KRW:'Südkoreanischer Won', RUB:'Russischer Rubel', BRL:'Brasilianischer Real', SAR:'Saudi-Riyal', TRY:'Türkische Lira', MXN:'Mexikanischer Peso', CLP:'Chilenischer Peso', IDR:'Indonesische Rupiah', PLN:'Polnischer Zloty', PKR:'Pakistanische Rupie' },
        fr: { USD:'Dollar américain', EUR:'Euro', CAD:'Dollar canadien', AUD:'Dollar australien', GBP:'Livre sterling', NZD:'Dollar néo-zélandais', JPY:'Yen japonais', INR:'Roupie indienne', CNY:'Yuan chinois', KRW:'Won sud-coréen', RUB:'Rouble russe', BRL:'Réal brésilien', SAR:'Riyal saoudien', TRY:'Livre turque', MXN:'Peso mexicain', CLP:'Peso chilien', IDR:'Roupie indonésienne', PLN:'Zloty polonais', PKR:'Roupie pakistanaise' },
        it: { USD:'Dollaro statunitense', EUR:'Euro', CAD:'Dollaro canadese', AUD:'Dollaro australiano', GBP:'Sterlina britannica', NZD:'Dollaro neozelandese', JPY:'Yen giapponese', INR:'Rupia indiana', CNY:'Yuan cinese', KRW:'Won sudcoreano', RUB:'Rublo russo', BRL:'Real brasiliano', SAR:'Riyal saudita', TRY:'Lira turca', MXN:'Peso messicano', CLP:'Peso cileno', IDR:'Rupia indonesiana', PLN:'Zloty polacco', PKR:'Rupia pakistana' },
        pt: { USD:'Dólar americano', EUR:'Euro', CAD:'Dólar canadense', AUD:'Dólar australiano', GBP:'Libra esterlina', NZD:'Dólar neozelandês', JPY:'Iene japonês', INR:'Rúpia indiana', CNY:'Yuan chinês', KRW:'Won sul-coreano', RUB:'Rublo russo', BRL:'Real brasileiro', SAR:'Riyal saudita', TRY:'Lira turca', MXN:'Peso mexicano', CLP:'Peso chileno', IDR:'Rúpia indonésia', PLN:'Zloti polonês', PKR:'Rúpia paquistanesa' },
        ...
        ru: { USD:'Доллар США', EUR:'Евро', CAD:'Канадский доллар', AUD:'Австралийский доллар', GBP:'Британский фунт', NZD:'Новозеландский доллар', JPY:'Японская иена', INR:'Индийская рупия', CNY:'Китайский юань', KRW:'Южнокорейская вона', RUB:'Российский рубль', BRL:'Бразильский реал', SAR:'Саудовский риял', TRY:'Турецкая лира', MXN:'Мексиканское песо', CLP:'Чилийское песо', IDR:'Индонезийская рупия', PLN:'Польский злотый', PKR:'Пакистанская рупия' },
        hi: { USD:'अमेरिकी डॉलर', EUR:'यूरो', CAD:'कनाडाई डॉलर', AUD:'ऑस्ट्रेलियाई डॉलर', GBP:'ब्रिटिश पाउंड', NZD:'न्यूज़ीलैंड डॉलर', JPY:'जापानी येन', INR:'भारतीय रुपया', CNY:'चीनी युआन', KRW:'दक्षिण कोरियाई वॉन', RUB:'रूसी रूबल', BRL:'ब्राज़ीलियाई रियल', SAR:'सऊदी रियाल', TRY:'तुर्की लीरा', MXN:'मैक्सिकन पेसो', CLP:'चिलियाई पेसो', IDR:'इंडोनेशियाई रुपिया', PLN:'पोलिश ज़्लॉटी', PKR:'पाकिस्तानी रुपया' },
        pl: { USD:'Dolar amerykański', EUR:'Euro', CAD:'Dolar kanadyjski', AUD:'Dolar australijski', GBP:'Funt szterling', NZD:'Dolar nowozelandzki', JPY:'Jen japoński', INR:'Rupia indyjska', CNY:'Juan chiński', KRW:'Won południowokoreański', RUB:'Rubel rosyjski', BRL:'Real brazylijski', SAR:'Riyal saudyjski', TRY:'Lira turecka', MXN:'Peso meksykańskie', CLP:'Peso chilijskie', IDR:'Rupia indonezyjska', PLN:'Złoty polski', PKR:'Rupia pakistańska' },
        ur: { USD:'امریکی ڈالر', EUR:'یورو', CAD:'کینیڈین ڈالر', AUD:'آسٹریلین ڈالر', GBP:'برطانوی پاؤنڈ', NZD:'نیوزی لینڈ ڈالر', JPY:'جاپانی ین', INR:'بھارتی روپیہ', CNY:'چینی یوان', KRW:'جنوبی کوریائی وون', RUB:'روسی روبل', BRL:'برازیلی ریال', SAR:'سعودی ریال', TRY:'ترکی لیرا', MXN:'میکسیکن پیسو', CLP:'چلی پیسو', IDR:'انڈونیشیائی روپیہ', PLN:'پولش زلوٹی', PKR:'پاکستانی روپیہ' }
    };
    ...
    var langToCurrency = { es:'EUR', en:'USD', ar:'SAR', zh:'CNY', ja:'JPY', ko:'KRW', id:'IDR', de:'EUR', fr:'EUR', it:'EUR', pt:'BRL', tr:'TRY', ru:'RUB', hi:'INR', pl:'PLN', ur:'PKR' };
