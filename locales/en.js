...
(function () {
    ...
    window.EcoLocales.en = {
        ...
        product_camara: 'Pet Collar Camera',
        ...
        checkout_treatment_sr: 'Mr.',
        checkout_treatment_sra: 'Ms.',
        checkout_contact_section: 'Contact',
        checkout_email_label: 'Email address',
        checkout_email_placeholder: 'you@email.com',
        checkout_address_section: 'Shipping address',
        checkout_country_label: 'Country',
        checkout_country_placeholder: 'Select a country',
        checkout_firstname_label: 'First name',
        checkout_firstname_placeholder: 'Your first name',
        checkout_lastname_label: 'Last name',
        checkout_lastname_placeholder: 'Your last name',
        checkout_address1_label: 'Address and house number',
        checkout_address1_placeholder: '123 Main Street',
        checkout_address2_label: 'Apartment, building, etc.',
        checkout_address2_placeholder: 'Apt 4B, Central Building...',
        checkout_address2_optional: '(optional)',
        checkout_province_label: 'Province / State',
        checkout_province_placeholder: 'Province',
        ...
        checkout_phone_placeholder: '+1 555 000 0000',
        checkout_notes_label: 'Notes',
        checkout_notes_placeholder: 'Special delivery instructions...',
        checkout_notes_optional: '(optional)',
        checkout_continue_btn: 'Continue',
        checkout_close_aria: 'Close delivery form',
        checkout_err_required: 'This field is required',
