...
(function () {
    ...
    window.EcoLocales.ko = {
        ...
        review_2_body: '상점 설명과 똑같이 미니멀하고 우아한 디자인입니다. 6시간 연속 사용 후에도 편안합니다. 배터리는 약속한 대로 지속됩니다.',
        review_3_title: '재택근무에 완벽함',
        review_3_body: '화상통화에 사용하는데 사람들이 항상 목소리가 잘 들린다고 말합니다. 마이크가 목소리를 정확하게 포착하고 차음성이 훌륭합니다.',
        review_4_title: '더 비싼 브랜드를 능가함',
        review_4_body: '훨씬 비싼 브랜드에서 바꿨는데 가격 차이가 정당화되지 않습니다. 이 EcoZox는 편안함에서 우수하며 액티브 노이즈 캔슬링도 정말 효과적입니다.',
        review_5_title: '완벽한 선물',
        review_5_body: '남편을 위해 구매했는데 매우 기뻐했습니다. 포장이 매우 꼼꼼하게 되어 있었고 제품은 사진과 정확히 일치합니다. 적극 추천합니다.',
        review_6_title: '편안하고 내구성 있음',
        review_6_body: '3개월 집중 사용 후에도 첫날과 같습니다. 이어쿠션이 매우 부드럽고 재질이 이 가격대에서 예상치 못한 견고함을 전달합니다.',
        review_7_title: '매우 좋지만 한 가지 아쉬운 점',
        review_7_body: '음질과 디자인은 훌륭합니다. 동반 앱이 더 직관적이면 좋겠다는 이유로 별 하나를 뺐습니다. 그 외에는 매우 추천할 만한 구매입니다.'
    };
})()
