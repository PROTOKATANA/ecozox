...
(function () {
    ...
    window.EcoLocales.ja = {
        ...
        trust_title: 'お客様の安心が第一です',
        trust_desc: 'オンラインショッピングには信頼が必要だと理解しています。商品がご期待に沿わない場合や欠陥がある場合もご安心ください。お客様の利便性を重視した返品プロセスを設計しています。',
        trust_feature_1: 'ご注文受取後30日以内の柔軟な返品オプション。',
        ...
        review_2_body: 'ストアで説明されているとおり、ミニマルでエレガントなデザイン。6時間の連続使用後でも快適です。バッテリーは約束通りの持続時間です。',
        review_3_title: '在宅ワークに最適',
        review_3_body: 'ビデオ通話で使っていますが、声がとても聞き取りやすいと言われます。マイクが声を正確に捉え、遮音性も優れています。',
        review_4_title: '高価格帯ブランドを超える',
        review_4_body: 'はるかに高価なブランドから乗り換えましたが、価格差は正当化されません。このEcoZoxは快適さで優れており、アクティブノイズキャンセリングも本当に効果的です。',
        review_5_title: '完璧なギフト',
        review_5_body: '夫へのプレゼントとして購入しましたが、大喜びでした。丁寧なパッケージで届き、製品は写真通りです。強くお勧めします。',
        review_6_title: '快適で耐久性抜群',
        review_6_body: '3ヶ月の集中使用後も初日のようです。イヤークッションは非常にソフトで、この価格帯では予想外の堅牢さを感じます。',
        review_7_title: 'とても良いが、一点だけ',
        review_7_body: '音質とデザインは素晴らしいです。専用アプリがもう少し直感的であればと思い、星一つ減らしました。それ以外は非常にお勧めできる買い物です。'
    };
})()