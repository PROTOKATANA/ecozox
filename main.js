document.addEventListener('DOMContentLoaded', () => {
    ...
    dividers.forEach((divider, index) => {
        ...
        // Construir rutas de relleno para eliminar la línea recta (seam)
        const pathFillTop = `${pathLine} L ${width * 2} 0 L -${width} 0 Z`;
        const pathFillBottom = `${pathLine} L ${width * 2} ${svgHeight} L -${width} ${svgHeight} Z`;
